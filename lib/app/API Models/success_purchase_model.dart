...
SuccessPurchaseModel successPurchaseModelFromJson(String str) =>
    SuccessPurchaseModel.fromJson(json.decode(str));
String successPurchaseModelToJson(SuccessPurchaseModel data) =>
