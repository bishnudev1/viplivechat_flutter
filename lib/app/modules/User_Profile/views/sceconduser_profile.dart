...
import 'package:rayzi/app/modules/User_Profile/views/second_userprofil_post.dart';
import 'package:shimmer/shimmer.dart';

import '../../../data/APP_variables/AppVariable.dart';
import '../../Messages/views/Message_Show.dart';
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    CircleAvatar(
                                      ...
                                      backgroundImage: (userProfileController.postData["userProfile"]["isFake"] ==
                                              true)
                                          ? NetworkImage(
                                              "${Constant.baseUrl}${userProfileController.postData["userProfile"]["profileImage"].toString()}")
                                          : NetworkImage(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: Text(
                                                userProfileController.postData["userProfile"]["country"]
                                                    .toString(),
                                                style: TextStyle(
                                    ...
                                    children: [
                                      GestureDetector(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              userProfileController.postData["userProfile"]["diamond"].toString(),
                                      ...
                                      GestureDetector(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              userProfileController.postData["userProfile"]["totalLike"]
                                                  .toString(),
                                              style: const TextStyle(
                                                fontFamily: 'abold',
                                                fontSize: 18,
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              userProfileController.postData["userProfile"]["followers"]
                                                  .toString(),
                                              style: const TextStyle(
                                                fontFamily: 'abold',
                                                fontSize: 18,
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              userProfileController.postData["userProfile"]["following"]
                                                  .toString(),
                                              style: const TextStyle(
                                                fontFamily: 'abold',
                                                fontSize: 18,
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        branchIOController.imageURL.value = userProfileController
                                            .postData["userProfile"]["profileImage"]
                                            .toString();
                                        branchIOController.initDeepLinkDataProfile(
                                          shareType: 1,
                                          profileUserID:
                                              userProfileController.postData["userProfile"]["_id"].toString(),
                                        );
                                        ...
                                        if (userProfileController.postData["userProfile"]["isFake"] == true) {
                                          Get.to(() => FakeMessageShow(
                                                images:
                                                    // '${Constant.baseUrl}${userProfileController.postData["userProfile"]["profileImage"].toString()}',
                                                    '${userProfileController.postData["userProfile"]["profileImage"]}',
                                                name: userProfileController.postData["userProfile"]["name"]
                                                    .toString(),
                                                userId: userProfileController.postData["userProfile"]["_id"]
                                                    .toString(),
                                                videoUrl:
                                                    '${Constant.baseUrl}${userProfileController.postData["userProfile"]["video"].toString()}',
                                              ));
                                        } else {
                                          Get.to(MessageShow(
                                            images: userProfileController.postData["userProfile"]["profileImage"]
                                                .toString(),
                                            name: userProfileController.postData["userProfile"]["name"].toString(),
                                            userId2:
                                                userProfileController.postData["userProfile"]["_id"].toString(),
                                            chatRoomId:
                                                userProfileController.chatTopicModel!.chatTopic!.id.toString(),
                                            senderId: userID,
                                    ...
                                    return GestureDetector(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          ...
                                          border:
                                              Border.all(color: ThemeColor.grayIcon.withOpacity(0.3), width: 2),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              userProfileController.blockRequest(
                  blockUser: userProfileController.postData["userProfile"]["_id"].toString());
            },
            child: SizedBox(
              height: 55,
              child: Row(
