                            ...
                            child: SizedBox(
                              child: ListView.separated(
                                ...
                                separatorBuilder: (context, index) {
                                  return Divider(
                                    color:
                                        ThemeColor.graylight.withOpacity(0.3),
                                    thickness: 0.8,
                                  );
                                },
            ...
            children: [
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      ...
                      foregroundImage: NetworkImage(userPostControllre
                          .postData[index]["profileImage"]
                          .toString()),
                    ),
                    const SizedBox(
                      width: 10,
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    userPostControllre.deletePostIs(
                                        "${userPostControllre.postData[index]["_id"]}");
                                    Get.back();
                                  },
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.start,
              ...
              ConstrainedBox(
                ...
                child: CachedNetworkImage(
                  ...
                  imageUrl: userPostControllre.postData[index]["postImage"]
                      .toString(),
                ...
                child: Row(
                  children: [
                    LikeButton(
                      ...
                      onTap: (isLiked) async {
                        userPostControllre.sendLike(
                            index, userPostControllre.postData[index]['_id']);
                        return !isLiked;
                      },
                      likeBuilder: (isLike) {
                    ...
                    GestureDetector(
                      onTap: () => Get.to(CommentScreen(
                        postID: userPostControllre.postData[index]["_id"]
                            .toString(),
                        index: index,
                        postScreenType: 1,
                      )),
              ...
              (userPostControllre.postData[index]["description"].toString() ==
                  ...
                  : Padding(
                      ...
                      child: ConstrainedBox(
                        ...
                        child: Text(
                          userPostControllre.postData[index]["description"]
                              .toString(),
                          style: TextStyle(
                              fontFamily: 'amidum',
                              fontSize: 15,
              ...
              GetBuilder<UserPostController>(
                builder: (controller) => Padding(
                  padding: EdgeInsets.only(
                      right: 10,
                      left: (userPostControllre.getAllPostModel!
                  ...
                  child: Row(
                    ...
                    children: [
                      //// ==== ==== Like List ==== ==== \\\\
                      (userPostControllre.getAllPostModel!.userPost![index]
                              .userGift!.isNotEmpty)
                          ? (userPostControllre.getAllPostModel!
              ...
              Padding(
                ...
                child: Obx(
                  () => GestureDetector(
                    onTap: () => Get.to(CommentScreen(
                      postID:
                          userPostControllre.postData[index]["_id"].toString(),
                      index: index,
                      postScreenType: 1,
                    )),
                    child: Text(
