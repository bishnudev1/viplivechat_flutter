                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          await CreatePostServices()
                              .createPostServices(discription.text, proImage!);
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            alignment: Alignment.center,
                            child: (userProfileController.postLoding.value)
                                ? Center(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    CircleAvatar(
                                      ...
                                      //     "${userProfileController.profileData["userProfile"]["profileImage"].toString()}"),
                                      backgroundImage:
                                  ...
                                  delegate: SliverChildBuilderDelegate(
                                    (context, index) {
                                      return GestureDetector(
                                        onTap: () => Get.off(
                                            const UserProfilePostScreen()),
                                        child: Container(
                                          decoration: BoxDecoration(
                                            // color:
                                            //     ThemeColor.grayIcon.withOpacity(0.6),
                                            borderRadius:
                                    ...
                                    childCount: userProfileController
                                        .profileData["userProfile"]["userPost"]
                                        .length,
                                  ),
                                ),
                              ),
