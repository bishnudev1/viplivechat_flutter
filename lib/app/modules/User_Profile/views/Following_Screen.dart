...
import 'sceconduser_profile.dart';
...
class _FollowingScreenState extends State<FollowingScreen> {
  FollowingScreenController followingController =
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            onTap: () => Get.off(SecondUserProfileView(
                              userID:
                                  "${followingController.followingList[index].to!.id}",
                            )),
                            child: Row(
                              ...
                              children: [
                                CircleAvatar(
                                  ...
                                  backgroundImage: (followingController
                                              .followingList[index]
                                              .to!
                                              .isFake ==
                                          true)
                                      ? NetworkImage(
                                          "${Constant.baseUrl}${followingController.followingList[index].to!.profileImage}",
                                        )
                                      : NetworkImage(
                                ...
                                Text(
                                  followingController.followingList[index].to!
                                              .name!.length >
                                          15
