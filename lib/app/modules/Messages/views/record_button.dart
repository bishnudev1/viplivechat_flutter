...
class _RecordButtonState extends State<RecordButton> {
  ...
  MessageShowController messageShowController =
      Get.put(MessageShowController());
  FakeMessageShowController fakeMessageShowController =
        ...
        child: Padding(
          ...
          child: GestureDetector(
            ...
            onTap: () async {
              ...
              if (widget.isFake) {
                /// =============================================
                fakeMessageShowController.onTabSend(
                    messageType: 4, message: "", assetFile: audioFile);
                log("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
              } else {
