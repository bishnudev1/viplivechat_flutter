...
class _MessageShowState extends State<MessageShow> with SingleTickerProviderStateMixin {
  ...
  void connect() {
    ...
    socket.onConnect((data) {
      ...
      socket.on("chat", (msg) {
        ...
        } else if (messageShowController.dateYt.last ==
            messageShowController.dateYt[messageShowController.dateYt.length - 2]) {
  ...
  void setMessage({
    ...
    ChatShowModel messageModel = ChatShowModel(
        messageType: messageType, message: message, profilePic: "", messageTime: date, senderID: senderId);
    setState(() {
      ...
      setState(() {
        messageShowController.scrollController
            .animateTo(0.0, duration: const Duration(milliseconds: 300), curve: Curves.easeOut);
      });
    });
  }
                                      ...
                                      return Column(
                                        children: [
                                          ...
                                          ReceiveDummyMessage(
                                            ...
                                            messageType:
                                                messageShowController.oldChatList[reversedIndex].messageType,
                                            callType:
                                                (messageShowController.oldChatList[reversedIndex].messageType == 5)
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: ImageIcon(const AssetImage("Images/Message/gallery2.png"),
                                      color: ThemeColor.blackback),
                                ),
                              ),
                              ConstrainedBox(
                                ...
                                child: SizedBox(
                                  width: (messageShowController.isButtonDisabled)
                                      //? 250
                                      ? Get.width - 133.5
                                      : Get.width - 100,
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintStyle: TextStyle(
                                            fontFamily: 'amidum', fontSize: 14, color: ThemeColor.graylight),
                                      ),
                                    ),
                                  ),
                                ),
                              ...
                              if (userCoins.value == 0) {
                                Fluttertoast.showToast(
                                  ...
                                  (messageShowController
                                          .getGiftList[messageShowController.selectedGiftIndex.value].coin!
                                          .toInt() *
                                ...
                                socket.emit("chat", {
                                  ...
                                  "receiverUserId": widget.userId2,
                                  "gift": messageShowController
                                      .getGiftList[messageShowController.selectedGiftIndex.value],
                                  "message":
                                      "${Constant.baseUrl}${messageShowController.getGiftList[messageShowController.selectedGiftIndex.value].image.toString()}",
                                  "messageType": 1,
                                  "coin":
