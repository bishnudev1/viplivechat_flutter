        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
                image: AssetImage("Images/QuickLoginScreenBG.png"),
                fit: BoxFit.cover),
          ),
          child: SizedBox(
            child: Padding(
                        ...
                        Column(
                          children: [
                            Obx(
                              () => InkWell(
                                onTap: () {
                                  if (quickLoginController.maleUser.value ==
                                      false) {
                                  ...
                                  children: [
                                    (quickLoginController.maleUser.value)
                                        ? CircleAvatar(
                                            radius: 34,
                                            backgroundColor:
                                                ThemeColor.greAlpha20,
                                            backgroundImage: const AssetImage(
                                                "Images/Gender/Color/Boy.png"),
                                          )
                                        : CircleAvatar(
                                            radius: 34,
                                            backgroundColor:
                        ...
                        Column(
                          children: [
                            Obx(
                              () => InkWell(
                                onTap: () {
                                  if (quickLoginController.femaleUser.value ==
                                      false) {
                                    quickLoginController.femaleUser.value =
                                        true;
                      ...
                      builder: (controller) => Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Image.asset(
                              "lottie/animation_640_lensc5lq.gif",
                            ),
                          ),
                          const SizedBox(
                            width: 15,
                            ...
                            child: Container(
                              ...
                              child: GetBuilder<QuickLoginController>(
                                builder: (controller) => TextField(
                                  controller:
                                      quickLoginController.locationController,
                                  maxLines: 1,
                                  cursorColor: ThemeColor.blackback,
                                  style: TextStyle(
                                    fontFamily: 'amidum',
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    fillColor: Colors.transparent,
                                    hintText:
                                        quickLoginController.currentAddress,
                                    hintStyle: const TextStyle(
                                      fontFamily: 'amidum',
                                      fontSize: 15,
                                    ),
