...
class CommentScreenController extends GetxController {
  ...
  SecoundPostController secoundPostController =
      Get.put(SecoundPostController());
  ...
  void sendComment(
    ...
    if (postScreenType == 0) {
      showPostController.commentCount[index] =
          showPostController.commentCount[index] + 1;
    } else if (postScreenType == 1) {
      _userPostController.commentCount[index] =
          _userPostController.commentCount[index] + 1;
    } else if (postScreenType == 2) {
      secoundPostController.commentCount[index] =
          secoundPostController.commentCount[index] + 1;
    } else if (postScreenType == 3) {
      singlePostController.commentCount[index] =
          singlePostController.commentCount[index] + 1;
    }
