...
import 'package:rayzi/app/modules/Show_Post/views/CommentScreen.dart';
import 'package:rayzi/app/modules/User_Profile/views/sceconduser_profile.dart';
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: (showPostController.postLoding.value)
                              ...
                              : Text("Post",
                                  style:
                                      TextStyle(color: ThemeColor.white, fontSize: 18, fontFamily: 'abold')),
                        ),
                      ),
                    ),
                    const SizedBox(
                        ...
                        child: Container(
                          ...
                          child: Obx(
                            () => (showPostController.postLoding.value)
                                ...
                                : Text("Post",
                                    style: TextStyle(
                                        color: ThemeColor.white, fontSize: 18, fontFamily: 'abold')),
                          ),
                        ),
                      ),
                    ),
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      ...
                      foregroundImage: (showPostController.postData[index]["isFake"] == true)
                          ? NetworkImage("${showPostController.postData[index]["profileImage"]}")
                          : NetworkImage(showPostController.postData[index]["profileImage"].toString()),
                    ),
                    const SizedBox(
                      width: 10,
                    ),
                                            ...
                                            child: GestureDetector(
                                              onTap: () {
                                                showPostController.sendReport(
                                                    ...
                                                    postimage: showPostController.postData[index]["postImage"]
                                                        .toString());
                                              },
                                              child: Container(
                                                height: 60,
            ...
            ConstrainedBox(
              constraints:
                  BoxConstraints(minHeight: 350, maxHeight: 500, maxWidth: Get.width, minWidth: Get.width),
            ...
            GetBuilder<ShowPostController>(
              builder: (controller) => Padding(
                padding: EdgeInsets.only(
                    right: 10,
                    left: (showPostController.getAllPostModel!.userPost![index].userLike!.length == 1)
                        ? 10.0
                        : 5.0),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                                  ...
                                  Stack(
                                    children: [
                                      ...
                                      Positioned(
                                        bottom: 0,
                                        right: 0,
                                        child: Image.asset("Images/Profile/diamond.png", width: 10),
                                      ),
                                    ],
                                  ),
                                  const SizedBox(
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                width: 50,
                decoration: BoxDecoration(
                    color: ThemeColor.pink, borderRadius: const BorderRadius.all(Radius.circular(10))),
              ),
              const SizedBox(
                height: 6,
              ),
                                ...
                                onTap: () async {
                                  if (userCoins.value == 0) {
                                    ...
                                    Get.back();
                                      ...
                                      (showPostController
                                              .getGiftList[showPostController.selectedGiftIndex.value].coin!
                                              .toInt() *
                                    ...
                                    showPostController.sendGift(
                                        giftId: showPostController
                                            .getGiftList[showPostController.selectedGiftIndex.value].id
                                            .toString(),
                                        postId: showPostController.postData[index]["_id"].toString(),
                                        index: index,
