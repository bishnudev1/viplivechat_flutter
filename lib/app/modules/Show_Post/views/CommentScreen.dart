...
class _CommentScreenState extends State<CommentScreen> {
  CommentScreenController commentScreenController =
      Get.put(CommentScreenController());
  @override
  void initState() {
            ...
            Obx(
              () => (commentScreenController.isLoding.value)
                  ? Expanded(
                      child: Center(
                        child:
                            CircularProgressIndicator(color: ThemeColor.pink),
                      ),
                    )
                          ...
                          child: SizedBox(
                            child: GetBuilder<CommentScreenController>(
                              builder: (controller) => ListView.separated(
                                controller:
                                    commentScreenController.scrollController,
                                shrinkWrap: true,
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle: TextStyle(
                                color: ThemeColor.grayIcon, fontSize: 14),
                            filled: true,
                      ...
                      onTap: () {
                        setState(() {
                          commentScreenController.sendComment(
                              ...
                              index: widget.index,
                              postScreenType: widget.postScreenType);
