                    ...
                    builder: (controller) => Column(
                      ...
                      children: [
                        (singlePostController.giftshow.value)
                            ? Image.network(
                                "${Constant.baseUrl}${singlePostController.getGiftList[singlePostController.selectedGiftIndex.value].image}",
                                fit: BoxFit.cover,
                                height: 150,
                                width: 150,
                              )
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage(
                            "${Constant.baseUrl}${singlePostController.getGiftList[i].image.toString()}"),
                        fit: BoxFit.cover,
                      ),
