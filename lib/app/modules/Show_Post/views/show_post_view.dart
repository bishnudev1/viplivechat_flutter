...
// import '../../User_Profile/views/sceconduser_profile.dart';
...
//                           ),
//                           alignment: Alignment.center,
//                           child: (showPostController.postLoding.value)
//                               ? Center(
...
//           },
//           child: Obx(
//             () => (showPostController.isLoding.value)
//                 ? Center(
//                     child: CircularProgressIndicator(
//                     color: ThemeColor.pink,
//                   ))
//                 : (showPostController.notData.value)
//                     ? Center(
//                         child: Image.asset(
...
//                                         ? Image.network(
//                                             "${Constant.baseUrl}${showPostController.getGiftList[showPostController.selectedGiftIndex.value].image}",
//                                             fit: BoxFit.cover,
//                                             height: 150,
//                                             width: 150,
//                                           )
...
//             GestureDetector(
//               onTap: () {
//                 if (showPostController.postData[index]["userId"].toString() ==
//                     userID) {
//                   Get.to(const UserProfileView());
//                 } else {
//                   Get.to(SecondUserProfileView(
//                     userID:
//                         showPostController.postData[index]["userId"].toString(),
//                   ));
//                 }
//               },
//               child: Padding(
//                 padding: const EdgeInsets.only(
//                     top: 4, bottom: 10, right: 10, left: 10),
//                 child: Row(
//                   children: [
//                     CircleAvatar(
//                       radius: 20,
//                       backgroundColor: Colors.grey.withOpacity(0.2),
//                       foregroundImage: (showPostController.postData[index]
//                                   ["isFake"] ==
//                               true)
//                           ? NetworkImage(
//                               "${showPostController.postData[index]["profileImage"]}")
//                           : NetworkImage(showPostController.postData[index]
//                                   ["profileImage"]
//                               .toString()),
//                     ),
//                     const SizedBox(
...
//                     GestureDetector(
//                       onTap: () {
//                         if (showPostController.postData[index]["userId"]
//                                 .toString() !=
//                             userID) {
//                           Get.bottomSheet(Container(
//                             height: 150,
...
//                                           ),
//                                           Text(
//                                             showPostController.postData[index]
//                                                     ["name"]
//                                                 .toString(),
//                                             style: TextStyle(
//                                                 color: ThemeColor.blackback,
...
//                         }
//                       },
//                       child: (showPostController.postData[index]["userId"]
//                                   .toString() ==
//                               userID)
//                           ? const SizedBox()
//                           : Icon(
...
//                 fit: BoxFit.cover,
//                 imageUrl:
//                     showPostController.postData[index]["postImage"].toString(),
...
//                     ),
//                     onTap: (isLiked) async {
//                       showPostController.sendLike(
//                           index, showPostController.postData[index]['_id']);
//                       return !isLiked;
//                     },
//                     likeBuilder: (isLike) {
...
//                       postID:
//                           showPostController.postData[index]["_id"].toString(),
//                       index: index,
//                       postScreenType: 0,
//                     )),
...
//                   GestureDetector(
//                     onTap: () {
//                       branchIOController.imageURL.value = showPostController
//                           .postData[index]["postImage"]
//                           .toString();
//                       branchIOController.initDeepLinkDataPost(
//                           shareType: 2,
//                           userId: showPostController.postData[index]["userId"]
//                               .toString(),
//                           postId: showPostController.postData[index]["_id"]
//                               .toString());
...
//                       child: Text(
//                         showPostController.postData[index]["description"]
//                             .toString(),
//                         style: TextStyle(
//                             fontFamily: 'amidum',
//                             fontSize: 15,
...
//                   ),
//             SizedBox(
//               height: (showPostController.postData[index]["description"]
//                           .toString() ==
//                       "")
//                   ? 0
//                   : 5,
...
//                     right: 10,
//                     left: (showPostController.getAllPostModel!.userPost![index]
//                                 .userLike!.length ==
//                             1)
//                         ? 10.0
//                         : 5.0),
...
//                   mainAxisAlignment: MainAxisAlignment.start,
//                   children: [
//                     (showPostController.getAllPostModel!.userPost![index]
//                             .userGift!.isNotEmpty)
//                         ? (showPostController.getAllPostModel!.userPost![index]
//                                     .userGift!.length ==
//                                 1)
...
//                                       items: showPostController.items
//                                           .map((int items) {
...
//                                       (showPostController
//                                               .getGiftList[showPostController
...
//                                             showPostController
//                                                 .dropdownvalue.value);
//                                     log("@@@@@@@@@@@@@@@@@COIN SENDE =====${showPostController.getGiftList[showPostController.selectedGiftIndex.value].coin!.toInt() * showPostController.dropdownvalue.value}");
...
//                       image: DecorationImage(
//                         image: NetworkImage(
//                             "${Constant.baseUrl}${showPostController.getGiftList[i].image.toString()}"),
//                         fit: BoxFit.cover,
//                       ),
