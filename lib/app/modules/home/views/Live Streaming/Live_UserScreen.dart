...
class _LiveUserScreenState extends State<LiveUserScreen> with SingleTickerProviderStateMixin {
  ...
  final _users = <int>[];
  List viewdata = [];
  double thisliveDiamond = 0;

  void connect() {
    log("heoll =============== ${widget.liveHostId}");
    var obj = json.encode({
    ...
    liveSocket.on("gift", (data) {
      ...
      setState(() {
        int diamond;
        diamond = int.parse("${data[0]["coin"]}");
        thisliveDiamond = thisliveDiamond + diamond;
        userDiamond = userDiamond + diamond;
        count = "${data[0]["count"]}";
      ...
      Future.delayed(const Duration(seconds: 5)).then((value) {
        setState(() {
          log("77777777777777777777777777777777777777777777");
          gift = "";
          count = "";
          showgift = false;
        });
                ...
                child: GetBuilder<LiveUsercontroller>(
                  builder: (controller) => TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            ...
                            // liveUsercontroller.sendComment(image:userProfile ,user:userName, message: liveUsercontroller.commentController.text );
                          },
                      ...
                      border:
                          OutlineInputBorder(borderSide: BorderSide.none, borderRadius: BorderRadius.circular(50)),
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            CircleAvatar(
                                              radius: 24,
                                              backgroundColor: ThemeColor.colorGrey,
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                Text(
                                                  userName,
                                                  style: TextStyle(
                                                      color: ThemeColor.white, fontSize: 16, fontFamily: 'amidum'),
                                                ),
                                                const SizedBox(
                                                  height: 5,
                                                ),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '$view',
                                                style: TextStyle(
                                                    fontFamily: 'amidum', color: ThemeColor.white, fontSize: 12),
                                              ),
                                            ],
                                          ),
                                        ),
                                            ...
                                            children: [
                                              ...
                                              GetBuilder<LiveUsercontroller>(
                                                builder: (controller) => Text(
                                                  // '01:09',
                                                  //"${liveUsercontroller.duration.inHours}:$minutes:$seconds",
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${viewdata[index]["name"]}',
                                        style:
                                            TextStyle(color: ThemeColor.white, fontFamily: 'alight', fontSize: 18),
                                      ),
                                      const Spacer(),
                                    ],
                                  ),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'in stream',
                                    style:
                                        TextStyle(color: ThemeColor.offwhite, fontFamily: 'amidum', fontSize: 15),
                                  ),
                                ],
                              ),
                              const Spacer(),
                          ...
                          child: Row(
                            ...
                            children: [
                              SizedBox(
                                height: 20,
                                width: 20,
                                child: Image.asset("Images/Profile/diamond.png"),
                              ),
                              const SizedBox(
                                width: 15,
                              ),
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            shape: BoxShape.circle,
                                            image: DecorationImage(
                                                image: NetworkImage(dummyCommentList[reversedIndex].image),
                                                fit: BoxFit.cover),
                                          ),
                                        ),
                                      ),
