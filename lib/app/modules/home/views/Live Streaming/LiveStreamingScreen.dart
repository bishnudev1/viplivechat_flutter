...
class _LiveStreamingScreenState extends State<LiveStreamingScreen>
  ...
  late PersistentBottomSheetController
      bottomSheetController; // <------ Instance variable
  final _users = <int>[];
  int view = 0;
  ...
  void connect() {
    log("heoll =============== ${widget.liveuserid}");
    var obj = json.encode({
      // "liveUserRoom": widget.liveuserid,
      "liveRoom": widget.liveStrimingid,
      "showUserRoom": userID,
    }.map((key, value) => MapEntry(key, value.toString())));
    liveStreamingSocket = io.io(
        Constant.baseUrl,
        io.OptionBuilder()
    ...
    liveStreamingSocket.onConnect((data1) {
      ...
      liveStreamingSocket.emit("addView", {
        ...
        "liveStreamingId": widget.liveStrimingid,
      ...
      liveStreamingSocket.on("gift", (data) async {
        ...
        setState(() {
          gift = "${Constant.baseUrl}${data[0]["gift"]["image"]}";
  ...
  @override
  void initState() {
    log("====1111${widget.token}=====${widget.liveuserid}====${widget.channelName}====${widget.mongoId}===${widget.liveStrimingid}==${widget.clientRole}");
    initialize();
    connect();
                            ...
                            GestureDetector(
                              onTap: () {
                                ...
                                branchIOController.initDeepLinkDataLiveStriming(
                                  ...
                                  liveStrimingid: widget.liveStrimingid,
                                  liveusername: userName,
                                  liveuserimage: userProfile.value,
                                  mongoId: widget.mongoId,
                                  diamond: widget.userDiamond,
                                );
                      ...
                      SizedBox(
                        ...
                        child: Obx(
                          () => (liveStreamingController.giftLoading.value)
                              ...
                              : ListView.builder(
                                  shrinkWrap: true,
                                  itemCount: liveStreamingController
                                      .getGiftList.length,
                                        ...
                                        if (userCoins.value == 0) {
                                          Fluttertoast.showToast(
                                            ...
                                            (liveStreamingController
                                                    .getGiftList[index].coin!
                                                    .toInt() *
                                                1)) {
                                          int cutCoin = liveStreamingController
                                                  .getGiftList[index].coin!
                                                  .toInt() *
                                              1;
                                          userCoins.value =
                                              userCoins.value - cutCoin;
                                          getstorage.write(
                                              "UserCoins", userCoins.value);
                                          liveStreamingSocket.emit("UserGift", {
                                            "coin": "$cutCoin",
                                            "liveStreaming":
                                                widget.liveStrimingid,
                                            "senderUserId": userID,
                                            "receiverUserId": widget.liveuserid,
                                            "showgift": true,
                                            "gift": liveStreamingController
                                                .getGiftList[index],
                                            "count": "x1",
                                          });
                                        } else {
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  image: DecorationImage(
                                                    ...
                                                    //     scrollSticker[index]),
                                                    image: NetworkImage(
                                                        "${Constant.baseUrl}${liveStreamingController.getGiftList[index].image}"),
                                                    fit: BoxFit.cover,
                                                  ),
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                      "${liveStreamingController.getGiftList[index].coin}",
                    ...
                    ? Positioned(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "x${liveStreamingController.dropdownvalue.value}",
                              style: TextStyle(
                                  fontFamily: "amidum",
                                  fontSize: 20,
                                  color: ThemeColor.white),
                              ...
                              child: Padding(
                                ...
                                child: Obx(
                                  () => DropdownButton(
                                    ...
                                    items: liveStreamingController.items
                                        .map((int items) {
                              ...
                              onTap: () async {
                                if (userCoins.value == 0) {
                                  ...
                                  Get.back();
                                    ...
                                    (liveStreamingController
                                            .getGiftList[liveStreamingController
                                  ...
                                  liveStreamingSocket.emit("UserGift", {
                                    "coin": "$cutCoins",
                                    "liveStreaming": widget.liveStrimingid,
                                    "senderUserId": userID,
                                    "receiverUserId": widget.liveuserid,
                                    "showgift": true,
                                    "gift": liveStreamingController.getGiftList[
                                        liveStreamingController
                                            .selectedGiftIndex.value],
                                    "count":
                                        "x${liveStreamingController.dropdownvalue.value}",
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        ...
                        image: NetworkImage(
                            "${Constant.baseUrl}${liveStreamingController.getGiftList[i].image}"),
                        fit: BoxFit.cover,
                      ),
                    ),
                    alignment: Alignment.center,
                        ...
                        onTap: () {
                          (dummyCommentList[reversedIndex].userID == userID)
                              ...
                              : Get.bottomSheet(
                                  ...
                                  ProfileDailog(
                                    userId:
                                        dummyCommentList[reversedIndex].userID,
                                  ));
                        },
                        child: Row(
