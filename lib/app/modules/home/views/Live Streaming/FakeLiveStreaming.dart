...
class _FakeLiveStreamingState extends State<FakeLiveStreaming> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.network(widget.videourl)
      // _controller = VideoPlayerController.network("${Constant.baseUrl}${widget.videourl}")
      ..initialize().then((_) {
        setState(() {
          _controller.play();
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          shape: BoxShape.circle,
                                          image: DecorationImage(
                                              // image: NetworkImage("${Constant.baseUrl}${widget.profileIamge}"),
                            ...
                            child: InkWell(
                              onTap: () async {
                                if (userCoins.value == 0) {
                                  ...
                                  getstorage.write("UserCoins", userCoins.value);
                                  emojiImage.add(
                                      "${Constant.baseUrl}${liveStreamingController.getGiftList[liveStreamingController.selectedGiftIndex.value].image!.toString()}");
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        ...
                        image: NetworkImage("${Constant.baseUrl}${liveStreamingController.getGiftList[i].image}"),
                        fit: BoxFit.cover,
                      ),
                    ),
                    alignment: Alignment.center,
